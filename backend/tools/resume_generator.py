...
jd="""Job Title
2027 Software Engineer Program - Full-Time - India
...
The Software Engineer Program (SEP) is a global two-year career development program, designed to
provide entry-level software engineering talent with foundational technical and professional skills which
enable them to build robust networks and establish successful careers at JPMorganChase. You will receive
opportunities for job growth, accelerated career advancement, and career mobility. The program starts
with an in-depth induction program that teaches you about our businesses, builds on your knowledge of
development methodologies, and sharpens your professional skills and will focus on holistic development
of your technology, professional, and leadership competencies and skills. You will dive head-first into
creating innovative solutions that make a difference for our customers, clients and employees.
...
• Write secure and high-quality code using the syntax of at least one programming language with
peer guidance
• Interpret architecture and design representations as well as nonfunctional requirements to
develop secure, stable software against a defined architecture
• Actively apply automation to reduce manual toil in the Software Development Life Cycle
• Gather, analyze, and synthesize basic data sets in service of technical troubleshooting and
generating insights to drive continuous improvements
...
the world.
• Participate in our Force for Good program to build real-world sustainable technology solutions for
...
• Pursuing a B.Tech/B.E degree with expected graduation by July 2027
...
Locations you may join in India:
• Bengaluru
• Hyderabad
• Mumbai
• Pune
...
For enquiries, please email us at code.for.good@jpmorgan.com .
JPMorganChase Code for Good Hackathon
2026 OFFICIAL RULES
ABOUT THE EVENT: Teams of students will compete against each other on behalf of a charity assigned to
them in order to provide a technological solution to a problem that the charity faces. The team or teams
which, in the opinion of JPMorgan Chase Bank, N.A. (“JPMC”), make the best attempt at developing such
a solution will receive a prize for themselves. All prizes are awarded “as is” and JPMC, to the fullest extent
permitted by law, makes no warranty or condition in respect of any prize or part thereof. JPMC reserves
the right to change any prize at its discretion.
All entries become the exclusive property of JPMC and will not be acknowledged or returned. By entering
the Code for Good Hackathon (“Hackathon”), entrants accept and agree to be bound by these Hackathon
Official Rules (the “Rules”) and the decisions of the judges, which shall be final, binding and conclusive on
all matters. In particular, the health and wellbeing of each team member is extremely important to JPMC.
If you require an accommodation for a medical condition, please contact JPMC Security. To the fullest

extent permitted by law, JPMC hereby disclaims any liability relating to any injury arising from a pre-
existing medical condition or a request for any requisite facilities and any subsequent injury, illness or

harm arising from such condition or lack of facilities."""
...
- Tailor the resume specifically for the job description
- Prioritize the most relevant projects
- Generate strong ATS-friendly bullet points
- Improve project descriptions
- Infer missing technical skills from GitHub repositories
...
major points
-include only 3-4 relevant projects
-if the part required in the template is not found,then remove it
...
content=content = response.text.strip()
